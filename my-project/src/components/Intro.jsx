...
function Intro() {
  const specs = [
    ...
    { value: "48MP", label: "Sistema da câmera", color: "text-blue-600" },
  ...
  return (
    <section className="bg-black py-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 "> iPhone 17 Pro</h1>
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
          ...
          Chip A18 Pro. Sitema de câmera Pro revolucionário
        </p>
      </div>
      <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-16">
        ...
        <button className="border-2 border-white  rounded-full hover:bg-white hover:text-black text-white px-8 py-4 text-lg font-medium hover:scale-105 transition-all duration-300 cursor-pointer">
          Saiba mais
        </button>
      </div>
      {/* Mapeando o array */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mx-auto max-w-5xl">
        {specs.map((spec, index) => (
          <div
            key={index}
            className=" cursor-pointer bg-gray-900 rounded-2xl p-6 hover:bg-gray-700 transition-all duration-300 hover:scale-105"
          >
